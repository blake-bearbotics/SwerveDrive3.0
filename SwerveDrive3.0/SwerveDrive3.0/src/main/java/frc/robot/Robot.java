...
public class Robot extends TimedRobot {
  ...
  private void driveWithJoystick(boolean fieldRelative) {
    ...
    final var xSpeed =
        -m_xspeedLimiter.calculate(MathUtil.applyDeadband(-m_controller.getLeftX(), 0.07))
    ...
    final var ySpeed =
        -m_yspeedLimiter.calculate(MathUtil.applyDeadband(m_controller.getLeftY(), 0.07))
            * Drivetrain.kMaxSpeed;
